    ...
    <body class="infobar-offcanvas">
        ...
        <div class="header">
            ...
            <section id="intro" class="section-intro">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="widget">
                                        <h3 class="block-title"><img src="{{secure_asset('FemmForce_Logo-2.png')}}" class="img-responsive" alt="Footer Logo"></h3>
                ...
                <script type="text/javascript" src="{{secure_asset('theme/jobboard-free-lite/assets/js/jquery.themepunch.revolution.min.js')}}"></script>
                <script type="text/javascript" src="{{secure_asset('theme/jobboard-free-lite/assets/js/jquery.themepunch.tools.min.js')}}"></script>
            </section>   
        </div>
